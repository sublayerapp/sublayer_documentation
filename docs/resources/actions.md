...
[AzureDevopsCreateEpicIssueAction](https://github.com/sublayerapp/sublayer_actions/blob/main/AzureDevops/azure_devops_create_epic_issue_action.rb): A sublayer action to create an issue within an epic in azure devops using their REST api and HTTParty
