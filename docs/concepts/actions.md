...
- **DataMigrationAction**: Facilitates the migration of data between different storage systems. This action supports various types of databases and file systems, ensuring the integrity and consistency of data during the transfer.
- **ExternalApiRequestAction**: Performs operations that require data from external APIs. This action can manage authentication, perform the request, and parse the results for further use in your system.
