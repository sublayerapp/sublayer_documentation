...
- [WriteFileAction](https://github.com/sublayerapp/sublayer_actions/blob/main/FileSystem/write_file_action.rb): Writes text to a specified file.
- [RunTestCommandAction](https://github.com/sublayerapp/sublayer_actions/blob/main/Testing/run_test_command_action.rb): Runs a test command on the command line returning the output.
- [GetContextAction](https://github.com/sublayerapp/sublayer_actions/blob/main/AI_Utilities/get_context_action.rb): Gathers context from surrounding files
