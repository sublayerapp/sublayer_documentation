...
### [Creating a Continuous Integration Pipeline with Sublayer]({% link docs/guides/ci-pipeline.md %})
* Learn how to integrate Sublayer into a CI pipeline for automated testing and deployment.

### [Integrating Third-Party Applications with Sublayer]({% link docs/guides/third-party-integration.md %})
* Explore how to connect third-party applications with Sublayer for extended functionalities.

### [Run Llama3.1 with Ollama]({% link docs/guides/running-local-llama31-with-ollama.md %})
Learn how to use Ollama to run Llama3.1 models locally.