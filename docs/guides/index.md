...
### [Full Example: Generators, Actions, and Agents Combined]({% link docs/guides/full_example.md %})

A comprehensive example illustrating how Generators, Actions, and Agents can be combined to form a complete workflow. 
